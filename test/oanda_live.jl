using Logging
using Persephone: getmarginavailable, getnav, islong, isshort
...
@testset "OandaBroker (live)" begin
    rtol_margin = 1e-2
    atol_margin = 200.0
    enabled = get(ENV, "PERSEPHONE_OANDA_LIVE", "") in ("1", "true", "TRUE")
    enabled || (Test.@test_skip "set ENV[PERSEPHONE_OANDA_LIVE]=1 to enable live OANDA tests"; return)
